...
namespace HuntersWP.Services
{
    public static class Helpers
    {
        ...
        public static void LogException(Exception ex, string operation)
        {
            ...
            et.Properties.Add("Operation", operation);
            App.TelemetryClient.TrackException(et);
        }

        public static void LogEvent(string name,Dictionary<string,string> values)
        {
            App.TelemetryClient.TrackEvent(name,values);
        }
        ...
        {
            StateService.ProgressIndicatorService.Show(message);
        }
