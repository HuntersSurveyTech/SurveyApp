...
namespace Netmera
{
    ...
    public class NetmeraService
    {
        ...
        /// <summary>
        /// Retrieves the list of <seealso cref="NetmeraContent"/> objects that matches with the query.
        /// </summary>
        /// <returns>List of the <seealso cref="NetmeraContent"/> object</returns>
        public List<NetmeraContent> search()
        {
        ...
        /// <summary>
        /// Creates <see cref="NetmeraUser"/> service object. It is used to search users.
        /// </summary>
        /// <returns><see cref="NetmeraService"/> object</returns>
        ...
        /// <returns><see cref="NetmeraContent"/> in the path</returns>
        public NetmeraContent get(String path)
        {
            return getFromNetwork(path);
        }
        ...
        protected internal String getUserCustomCondition()
        {
            ...
            {
                strBuild.Append(queries.ElementAt(i));
                if (i < (size - 1))
                {
                    strBuild.Append(",");
                }
