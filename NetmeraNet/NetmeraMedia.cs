...
namespace Netmera
{
    ...
    public class NetmeraMedia
    {
        ...
        /// </summary>
        /// <param name="size"> <seealso cref="PhotoSize"/> object</param>
        ...
        internal String save(String appId, String apiKey, String contentPath, String viewerId)
        {
            ...
            String responseData = getData(NetmeraConstants.Upload_Url, uploadMap);
            ...
            String respDataToImage = postImageAsData(strBuild.ToString(), data);
            ...
            String result = getData(strBuild.ToString(), null);
        ...
        private String getData(String url, Dictionary<String, Object> mapParams)
        {
            StringBuilder strBuild = new StringBuilder();
            strBuild.Append(url);
            if (mapParams != null)
