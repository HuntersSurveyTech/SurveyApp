    ...
    internal abstract class ALinqExpressionVisitor
    {
        internal virtual Expression Visit(Expression exp)
        {
            ...
            switch (exp.NodeType)
            {
                ...
                default:
                    throw new NotSupportedException(string.Format(CultureInfo.CurrentCulture, SR.ALinqUnsupportedExpression, exp.NodeType.ToString()));
            }
        }
        ...
        internal virtual MemberBinding VisitBinding(MemberBinding binding)
        {
            switch (binding.BindingType)
            {
                ...
                default:
                    throw new NotSupportedException(string.Format(CultureInfo.CurrentCulture, SR.ALinqUnsupportedExpression, binding.BindingType.ToString()));
            }
        }
