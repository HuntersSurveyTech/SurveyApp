...
namespace Microsoft.WindowsAzure.Storage.Table.Protocol
{
    ...
    internal class TableOperationHttpResponseParsers
    {
        ...
        internal static ResultSegment<TElement> TableQueryPostProcessGeneric<TElement>(Stream responseStream, Func<string, string, DateTimeOffset, IDictionary<string, EntityProperty>, string, TElement> resolver, HttpWebResponse resp)
        {
